...
QWidget* MainWindow::createMatchArea()
{
    ...
    QPushButton *addMatch = new QPushButton("Ajouter un match");
    addMatch->setStyleSheet("background-color: #00695c; color: white; padding: 10px 20px; border-radius: 10px; font-size: 16px;");
    addMatch->setFixedWidth(200);

    QHBoxLayout *topLayout = new QHBoxLayout;
    topLayout->addWidget(title);
    topLayout->addStretch();
    topLayout->addWidget(addMatch);
    ...
    QVBoxLayout *matchListLayout = new QVBoxLayout(scrollWidget);

    matchListLayout->setSpacing(15);
    matchListLayout->addWidget(createMatchCard("Equipe 1", "Equipe 2", "10:20", "Stade 1"));
    matchListLayout->addWidget(createMatchCard("Equipe 3", "Equipe 4", "11:20", "Stade 2"));
    matchListLayout->addWidget(createMatchCard("Equipe 5", "Equipe 6", "12:20", "Stade 3"));
    matchListLayout->addWidget(createMatchCard("Equipe 7", "Equipe 8", "13:20", "Stade 4"));
    matchListLayout->addWidget(createMatchCard("Equipe 9", "Equipe 10", "14:20", "Stade 5"));
    matchListLayout->addStretch();

    scrollWidget->setLayout(matchListLayout);
